...
const MatchmakerManager = require('./MatchmakerManager');
...
class XMPPManager {
    ...
    static async start() {
        ...
        this.domain = ConfigManager.get('xmppDomain') || 'prod.ol.epicgames.com';
    ...
    static async handleConnection(ws, req) {
        ...
        //LoggerService.log('info', 'New XMPP connection attempt');
