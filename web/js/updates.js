const VERSIONS = [
    {
        version: '1.2.6',
        title: 'Asset Pipeline & Web Rebuild',
        date: 'May 29, 2026',
        type: 'feature',
        latest: true,
        lts: false,
        summary: 'New unified Asset Pipeline (online CDN-redirect or local serving with one command), full /assets toolset with verification and integrity checks, versioned plugin manifests with per-version dependencies, and a complete website backend/frontend logic rebuild: all web routes namespaced under /neodyme/api/* with a single unified response shape, a per-user website rate limiter, account self-deletion, a fully functional friends & player-search dashboard, and a large frontend cleanup.',
        features: [
