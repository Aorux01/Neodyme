...
const { verifyToken, verifyServer } = require('../../src/middleware/auth-middleware');

router.get('/fortnite/api/v1/profile/:accountId/vbucks/get', verifyToken, verifyServer, async (req, res) => {
    try {
...
router.post('/fortnite/api/v1/profile/:accountId/vbucks/add', verifyToken, verifyServer, async (req, res) => {
    try {
        const { accountId } = req.params;
...
router.post('/fortnite/api/v1/profile/:accountId/vbucks/set', verifyToken, verifyServer, async (req, res) => {
    try {
        const { accountId } = req.params;
        const { amount } = req.body;
...
router.post('/fortnite/api/v1/profile/:accountId/vbucks/purchase', verifyToken, verifyServer, async (req, res) => {
    try {
        const { accountId } = req.params;
