...
router.post('/fortnite/api/v1/profile/:accountId/xp/add', verifyToken, verifyServer, async (req, res) => {
    try {
...
router.post('/fortnite/api/v1/profile/:accountId/xp/addSpecificAmount', verifyToken, verifyServer, async (req, res) => {
    try {
        const { accountId } = req.params;
...
router.get('/fortnite/api/v1/profile/:accountId/xp/get', verifyToken, verifyServer, async (req, res) => {
    try {
        const { accountId } = req.params;
...
router.post('/fortnite/api/v1/profile/:accountId/xp/setLevel', verifyToken, verifyServer, async (req, res) => {
    try {
        const { accountId } = req.params;
